                    ...
                    return (
                      <tr key={user.id}>
                        ...
                        <td className='d-flex justify-content-between'>
                          <button type="button" className="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target={`#${user?.id}`}>
                            Details
                          </button>

                          <div className="modal fade" id={`${user?.id}`} tabIndex={-1} aria-labelledby="userModalLabel" aria-hidden="true">
                          ...
                          <button type="button" className="btn btn-danger btn-sm" onClick={()=>handleDelete(id,profile_image)}>
                            Delete
                          </button>
                        </td>
                      </tr>
